...
CREATE TABLE PRODUCT (
	maker VARCHAR2(5) NOT NULL,
	model NUMBER PRIMARY KEY,
	type VARCHAR2(10) CHECK (type IN ('pc', 'laptop', 'printer')));
...
INSERT INTO PRODUCT (maker, model, type) VALUES ('E',1014,'laptop');
...
--- PC TUPLES (14)
INSERT INTO PC (model, speed, ram, hd, price) VALUES (1001,2.66,1024,250,2000);
...
INSERT INTO PC (model, speed, ram, hd, price) VALUES (1012,2.80,1024,160,650);
INSERT INTO PC (model, speed, ram, hd, price) VALUES (1013,3.06,512,80,529);
INSERT INTO PC (model, speed, ram, hd, price) VALUES (1014,3.06,512,80,651);
